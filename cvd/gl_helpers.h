...
/// @ingroup gGL
template <int N>
inline void glTranslate(const TooN::Vector<N>& v)
{
...
/// @ingroup gGL
template <>
inline void glTranslate(const TooN::Vector<2>& v)
{
...
/// @ingroup gGL
template <>
inline void glTranslate(const TooN::Vector<1>& v)
{
...
inline void glFrustum(const CAMERA& camera, double width, double height, double nearPlane = 0.1, double farPlane = 100)
{
...
/// @ingroup gGL
template <class C>
inline void glVertex(const C& list)
{
...
///@ingroup gGL
template <class C>
inline void glDrawPixels(const BasicImage<C>& i)
{
...
///@ingroup gGL
template <class C>
inline void glReadPixels(BasicImage<C>& i, ImageRef origin = ImageRef(0, 0))
{
...
///@ingroup gGL
template <class C>
inline Image<C> glReadPixels(ImageRef size, ImageRef origin = ImageRef(0, 0))
{
	Image<C> i(size);
...
/// @ingroup gGL
template <class C>
inline void glTexSubImage2D(const BasicImage<C>& i, GLint xoffset = 0, GLint yoffset = 0, GLenum target = GL_TEXTURE_2D, GLint level = 0)
{
