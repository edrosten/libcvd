...
namespace Internal
{
	...
	{
		static std::string name() { return "bayer_bggr"; }
	};
	template <>
	struct type_name<bayer_gbrg>
	{
		static std::string name() { return "bayer_gbrg"; }
	};
	template <>
	struct type_name<bayer_grbg>
	{
		static std::string name() { return "bayer_grbg"; }
	};
	template <>
	struct type_name<bayer_rggb>
	{
		static std::string name() { return "bayer_rggb"; }
	};

	template <>
	struct type_name<bayer_bggr16>
	{
		static std::string name() { return "bayer_bggr16"; }
	};
	template <>
	struct type_name<bayer_gbrg16>
	{
		static std::string name() { return "bayer_gbrg16"; }
	};
	template <>
	struct type_name<bayer_grbg16>
	{
		static std::string name() { return "bayer_grbg16"; }
	};
	template <>
	struct type_name<bayer_rggb16>
	{
		static std::string name() { return "bayer_rggb16"; }
	};

	template <>
	struct type_name<bayer_bggr16be>
	{
		static std::string name() { return "bayer_bggr16be"; }
	};
	template <>
	struct type_name<bayer_gbrg16be>
	{
		static std::string name() { return "bayer_gbrg16be"; }
	};
	template <>
	struct type_name<bayer_grbg16be>
	{
		static std::string name() { return "bayer_grbg16be"; }
	};
	template <>
	struct type_name<bayer_rggb16be>
	{
		static std::string name() { return "bayer_rggb16be"; }
	};

	template <>
	struct type_name<yuv411>
	{
		static std::string name() { return "yuv411"; }
	};
	template <>
	struct type_name<yuv422>
	{
		static std::string name() { return "yuv422"; }
	};
	template <>
	struct type_name<yuv420p>
	{
		static std::string name() { return "yuv420p"; }
	};
	template <>
	struct type_name<vuy422>
	{
		static std::string name() { return "vuy422"; }
	};

	template <>
	struct type_name<MJPEG>
	{
		static std::string name() { return "MJPEG"; }
	};
}
...
{
	template <int LIFT>
	struct traits<bayer_bggr, LIFT> : public traits<unsigned char, LIFT>
	{
	};

	template <int LIFT>
	struct traits<bayer_rggb, LIFT> : public traits<unsigned char, LIFT>
	{
	};

	template <int LIFT>
	struct traits<bayer_gbrg, LIFT> : public traits<unsigned char, LIFT>
	{
	};

	template <int LIFT>
	struct traits<bayer_grbg, LIFT> : public traits<unsigned char, LIFT>
	{
	};

	template <int LIFT>
	struct traits<bayer_bggr16, LIFT> : public traits<unsigned short, LIFT>
	{
	};

	template <int LIFT>
	struct traits<bayer_rggb16, LIFT> : public traits<unsigned short, LIFT>
	{
	};

	template <int LIFT>
	struct traits<bayer_gbrg16, LIFT> : public traits<unsigned short, LIFT>
	{
	};

	template <int LIFT>
	struct traits<bayer_grbg16, LIFT> : public traits<unsigned short, LIFT>
	{
	};

	template <int LIFT>
	struct traits<bayer_bggr16be, LIFT> : public traits<unsigned short, LIFT>
	{
	};

	template <int LIFT>
	struct traits<bayer_rggb16be, LIFT> : public traits<unsigned short, LIFT>
	{
	};

	template <int LIFT>
	struct traits<bayer_gbrg16be, LIFT> : public traits<unsigned short, LIFT>
	{
	};

	template <int LIFT>
	struct traits<bayer_grbg16be, LIFT> : public traits<unsigned short, LIFT>
	{
	};
}
