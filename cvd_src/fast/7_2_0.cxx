...
void fast_corner_detect_7(const BasicImage<byte>& im, vector<ImageRef>& corners,
int barrier)
{																								
                            ...
                            if(*(cache_1+-4) > cb)
                                ...
                                if(*(cache_2+4) > cb)
                                    ...
                                    if(*(cache_0 + pixel[5]) > cb)
                                        ...
                                        if(*(cache_0 + pixel[15]) > cb || *(cache_0 + pixel[15]) < c_b)
                                            continue;
                                        else
                                            if(*(cache_0 + pixel[7]) > cb)
                                                goto success;
